...
namespace ensambladora
{
    public partial class Form6 : Form
    {
        ...
        string archivo = Directory.GetCurrentDirectory() + "\\ReporteVentas.htm";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            arch.WriteLine("<html><meta charset=\"utf-8\">REPORTE DE VENTAS<br><br>");
            arch.WriteLine("<table border=1 cellspacing=0>");
            arch.WriteLine("<tr><td>ID_VENTA</td><td>I_CLIENTE</td><td>ID_COMPONENTE</td><td>MONTO</td><td>FECHA</td></tr>");
