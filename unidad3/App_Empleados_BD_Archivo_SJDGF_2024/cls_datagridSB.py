...
Fecha de última modificación: 05-Marzo-2024

Objetivo: 
La clase DataGridSB se provee con el fin de emula el desempeño del widget DataGridView  que existe 
en Visual C# .NET. 

Debido a que tkinter no cuenta con un widget tal como lo es el DataGridView, se proporciona esta clase 
...
class DataGridSB():
    ...
    def agregarRenglon(self, index_, text_, values_, tags_=""):    
        self.tvw1.insert(parent="", index=index_, text=text_, values=values_, tags=tags_)

    def vaciarDataGrid(self):
        for r in self.tvw1.get_children():  self.tvw1.delete(r)
